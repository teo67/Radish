    ...
    class Librarian {
        ...
        public Librarian(bool uselib = true) {
            ...
            if(uselib) {
                ...
                StandardSpecials.Add("GENERATEQR", new Values.Variable(new Values.FunctionLiteral(ImportStack, new List<string>() { "genqrsrc", "genqrtarget"}, new List<IOperator?>() { null, null}, false, new Operators.GenerateQR(new Operators.Reference("genqrsrc", -1, -1, this), new Operators.Reference("genqrtarget", -1, -1, this)), "Standard Library")));
