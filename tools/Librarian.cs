    ...
    class Librarian {
        ...
        public Librarian(bool uselib = true) {
            ...
            if(uselib) {
                ...
                StandardSpecials.Add(new Values.Variable("DOFILE", new Values.FunctionLiteral(ImportStack, new List<string>() { "dofile", "doread", "fileedit" }, new List<IOperator?>() { null, null, null }, false, new Operators.DoFile(new Operators.Reference("dofile", -1, -1, this), new Operators.Reference("doread", -1, -1, this), new Operators.Reference("fileedit", -1, -1, this)), "Standard Library")));
                StandardSpecials.Add(new Values.Variable("SIN", new Values.FunctionLiteral(ImportStack, new List<string>() { "sininput" }, new List<IOperator?>() { null }, false, new Operators.Sine(new Operators.Reference("sininput", -1, -1, this)), "Standard Library")));
                StandardSpecials.Add(new Values.Variable("COS", new Values.FunctionLiteral(ImportStack, new List<string>() { "cosinput" }, new List<IOperator?>() { null }, false, new Operators.Cosine(new Operators.Reference("cosinput", -1, -1, this)), "Standard Library")));
                StandardSpecials.Add(new Values.Variable("TAN", new Values.FunctionLiteral(ImportStack, new List<string>() { "taninput" }, new List<IOperator?>() { null }, false, new Operators.Tangent(new Operators.Reference("taninput", -1, -1, this)), "Standard Library")));
                StandardSpecials.Add(new Values.Variable("ASIN", new Values.FunctionLiteral(ImportStack, new List<string>() { "asininput" }, new List<IOperator?>() { null }, false, new Operators.Arcsine(new Operators.Reference("asininput", -1, -1, this)), "Standard Library")));
                StandardSpecials.Add(new Values.Variable("ACOS", new Values.FunctionLiteral(ImportStack, new List<string>() { "acosinput" }, new List<IOperator?>() { null }, false, new Operators.Arccosine(new Operators.Reference("acosinput", -1, -1, this)), "Standard Library")));
                StandardSpecials.Add(new Values.Variable("ATAN", new Values.FunctionLiteral(ImportStack, new List<string>() { "ataninput" }, new List<IOperator?>() { null }, false, new Operators.Arctangent(new Operators.Reference("ataninput", -1, -1, this)), "Standard Library")));
